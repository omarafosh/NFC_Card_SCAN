...
const translations = {
    ar: {
        ...
        two_factor_auth: 'المصادقة ثنائية الأبعاد (2FA)',
        two_factor_status: 'حالة المصادقة الثنائية',
        active: 'نشط',
        inactive: 'غير مفعل',
        disable_2fa: 'تعطيل 2FA',
        enable_2fa: 'تفعيل 2FA',
        security_desc: 'إضافة طبقة حماية إضافية لحسابك باستخدام تطبيق Google Authenticator.',
    },
    en: {
        // Sidebar & Navigation
        nav_home: 'Home',
        ...
        cash: 'Cash',
        wallet: 'Wallet',
        topup_success: 'Wallet recharged successfully',
        ...
        security_desc: 'Add an extra layer of security to your account using Google Authenticator.',
    }
};
